...
def get_scatter_plot(site, payload):
    ...
    if site == 'ALL' or site == 'All sites':
        ...
        filtered_df1 = filtered_df[filtered_df['Launch Site']==site]
